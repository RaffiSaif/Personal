...
async def amireallyalive(alive):
    ...
    if CAT_IMG:
        cat_caption  = f"__**✮ MY BOT IS RUNNING SUCCESFULLY @ Bomber ✮**__\n\n"
        ...
        await alive.edit(f"__**✮ MY BOT IS RUNNING SUCCESFULLY @Bomber ✮**__\n\n"
...
#Hello. These files are all private of Source Raffi Saif. 
#In short, there are files registered for Source, another group. 
#You do not need to write a file from the beginning for the sake of rights, 
#and there are complete files. Thank you for installing Raffi Saif. 
#Our channel is here: https://t.me/Bomber
